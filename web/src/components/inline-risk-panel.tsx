    ...
    >
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {assessment.indexed_summary_count > 0 && (
          <span
            className="ml-auto inline-flex items-center gap-1 text-[10px] text-violet-300 tabular-nums"
            title={`Reasoned over ${assessment.indexed_summary_count} guardian summaries`}
          >
            <svg
            ...
            <span>
              memory: {assessment.indexed_summary_count}
              {assessment.indexed_symbol_count
                && assessment.indexed_symbol_count > 0 ? (
                <>+{assessment.indexed_symbol_count}sym</>
              ) : null}
            </span>
          </span>
        )}
